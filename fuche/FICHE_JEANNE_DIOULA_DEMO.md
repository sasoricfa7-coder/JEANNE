# 🗣️ Jeanne-Dioula — Fiche technique de la démo
...
def generer_reponse_fr(message: str, historique: list[dict]) -> str: ...
    # historique format : [{"role": "user", "content": "..."}, {"role": "assistant", "content": "..."}, ...]

def traduire_fr_vers_dyu(texte: str) -> str: ...

def repondre(message_dyu: str, historique: list[dict]) -> tuple[str, list[dict]]:
    # Enchaîne les 3 fonctions ci-dessus. Retourne (reponse_en_dioula, historique_mis_a_jour)
